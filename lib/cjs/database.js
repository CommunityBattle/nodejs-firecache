...
var Database = /** @class */ (function () {
    ...
    Database.prototype.addListener = function (path, query, callback, error) {
        if (this.isDoc(path)) {
    ...
    Database.prototype.insert = function (path, data) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.firestore.doc(path).get()];
                    case 1:
                        doc = _a.sent();
                        if (!doc.exists) return [3 /*break*/, 2];
                        return [2 /*return*/, reject(new errors_js_1.AlreadyExists())];
                    case 2: return [4 /*yield*/, this.firestore.doc(path).create(data)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, resolve("")];
                    case 4: return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.firestore.collection(path).add(data)];
                    case 6:
                        doc = _a.sent();
                        resolve(doc.id);
                        _a.label = 7;
    ...
    Database.prototype.read = function (path, query) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (doc.exists) {
                            ...
                            return [2 /*return*/, reject(new errors_js_1.NoData())];
                        }
                        return [3 /*break*/, 4];
    ...
    Database.prototype.update = function (path, data) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var doc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.firestore.doc(path).update(data)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, resolve()];
                    case 3: return [2 /*return*/, reject(new errors_js_1.NoData())];
                    case 4: return [3 /*break*/, 6];
                    case 5: return [2 /*return*/, reject(new errors_js_1.CollectionUsedForDocumentOperation())];
                    case 6: return [2 /*return*/];
                }
            });
        }); });
    };
    Database.prototype.delete = function (path, query) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 10:
                        _e.sent();
                        return [2 /*return*/, resolve()];
                    case 11: return [2 /*return*/, reject(new errors_js_1.NoData())];
    ...
    Database.prototype.isDoc = function (path) {
        return (path.split("/").length % 2) == 0;
    };
    Database.prototype.resolve = function (path, query) {
